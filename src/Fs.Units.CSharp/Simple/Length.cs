...
{
    public static double InchToFeet(this double x) => Units.Length.Inch.toFeet(x);
    public static double InchToYards(this double x) => Units.Length.Inch.toYards(x);
    ...
    public static double InchToChains(this double x) => Units.Length.Inch.toChains(x);
    public static double InchToFurlongs(this double x) => Units.Length.Inch.toFurlongs(x);
    public static double InchToLeagues(this double x) => Units.Length.Inch.toLeagues(x);
    public static double InchToHands(this double x) => Units.Length.Inch.toHands(x);
    public static double InchToRods(this double x) => Units.Length.Inch.toRods(x);
}

public static class FootExtensions
{
    public static double FootToInches(this double x) => Units.Length.Foot.toInches(x);
    public static double FootToYards(this double x) => Units.Length.Foot.toYards(x);
    ...
    public static double FootToChains(this double x) => Units.Length.Foot.toChains(x);
    public static double FootToFurlongs(this double x) => Units.Length.Foot.toFurlongs(x);
    public static double FootToLeagues(this double x) => Units.Length.Foot.toLeagues(x);
    public static double FootToHands(this double x) => Units.Length.Foot.toHands(x);
    public static double FootToRods(this double x) => Units.Length.Foot.toRods(x);
}

public static class YardExtensions
{
    public static double YardToInches(this double x) => Units.Length.Yard.toInches(x);
    public static double YardToFeet(this double x) => Units.Length.Yard.toFeet(x);
    ...
    public static double YardToChains(this double x) => Units.Length.Yard.toChains(x);
    public static double YardToFurlongs(this double x) => Units.Length.Yard.toFurlongs(x);
    public static double YardToLeagues(this double x) => Units.Length.Yard.toLeagues(x);
    public static double YardToHands(this double x) => Units.Length.Yard.toHands(x);
    public static double YardToRods(this double x) => Units.Length.Yard.toRods(x);
}

public static class MileExtensions
{
    public static double MileToInches(this double x) => Units.Length.Mile.toInches(x);
    public static double MileToFeet(this double x) => Units.Length.Mile.toFeet(x);
    ...
    public static double MileToChains(this double x) => Units.Length.Mile.toChains(x);
    public static double MileToFurlongs(this double x) => Units.Length.Mile.toFurlongs(x);
    public static double MileToLeagues(this double x) => Units.Length.Mile.toLeagues(x);
    public static double MileToHands(this double x) => Units.Length.Mile.toHands(x);
    public static double MileToRods(this double x) => Units.Length.Mile.toRods(x);
}

public static class MillimeterExtensions
{
    public static double MillimeterToInches(this double x) => Units.Length.Millimeter.toInches(x);
    public static double MillimeterToFeet(this double x) => Units.Length.Millimeter.toFeet(x);
    ...
    public static double MillimeterToChains(this double x) => Units.Length.Millimeter.toChains(x);
    public static double MillimeterToFurlongs(this double x) => Units.Length.Millimeter.toFurlongs(x);
    public static double MillimeterToLeagues(this double x) => Units.Length.Millimeter.toLeagues(x);
    public static double MillimeterToHands(this double x) => Units.Length.Millimeter.toHands(x);
    public static double MillimeterToRods(this double x) => Units.Length.Millimeter.toRods(x);
}

public static class CentimeterExtensions
{
    public static double CentimeterToInches(this double x) => Units.Length.Centimeter.toInches(x);
    public static double CentimeterToFeet(this double x) => Units.Length.Centimeter.toFeet(x);
    ...
    public static double CentimeterToChains(this double x) => Units.Length.Centimeter.toChains(x);
    public static double CentimeterToFurlongs(this double x) => Units.Length.Centimeter.toFurlongs(x);
    public static double CentimeterToLeagues(this double x) => Units.Length.Centimeter.toLeagues(x);
    public static double CentimeterToHands(this double x) => Units.Length.Centimeter.toHands(x);
...
public static class MeterExtensions
{
    ...
    public static double MeterToFeet(this double x) => Units.Length.Meter.toFeet(x);
    public static double MeterToYards(this double x) => Units.Length.Meter.toYards(x);
    ...
    public static double MeterToFurlongs(this double x) => Units.Length.Meter.toFurlongs(x);
    public static double MeterToLeagues(this double x) => Units.Length.Meter.toLeagues(x);
    public static double MeterToHands(this double x) => Units.Length.Meter.toHands(x);
    public static double MeterToRods(this double x) => Units.Length.Meter.toRods(x);
}

public static class KilometerExtensions
{
    public static double KilometerToInches(this double x) => Units.Length.Kilometer.toInches(x);
    public static double KilometerToFeet(this double x) => Units.Length.Kilometer.toFeet(x);
    public static double KilometerToYards(this double x) => Units.Length.Kilometer.toYards(x);
    ...
    public static double KilometerToFurlongs(this double x) => Units.Length.Kilometer.toFurlongs(x);
    public static double KilometerToLeagues(this double x) => Units.Length.Kilometer.toLeagues(x);
    public static double KilometerToHands(this double x) => Units.Length.Kilometer.toHands(x);
    public static double KilometerToRods(this double x) => Units.Length.Kilometer.toRods(x);
}

public static class NauticalMileExtensions
{
    public static double NauticalMileToInches(this double x) => Units.Length.NauticalMile.toInches(x);
    public static double NauticalMileToFeet(this double x) => Units.Length.NauticalMile.toFeet(x);
    public static double NauticalMileToYards(this double x) => Units.Length.NauticalMile.toYards(x);
    ...
    public static double NauticalMileToFurlongs(this double x) => Units.Length.NauticalMile.toFurlongs(x);
    public static double NauticalMileToLeagues(this double x) => Units.Length.NauticalMile.toLeagues(x);
    public static double NauticalMileToHands(this double x) => Units.Length.NauticalMile.toHands(x);
    public static double NauticalMileToRods(this double x) => Units.Length.NauticalMile.toRods(x);
}

public static class ChainExtensions
{
    public static double ChainToInches(this double x) => Units.Length.Chain.toInches(x);
    public static double ChainToFeet(this double x) => Units.Length.Chain.toFeet(x);
    public static double ChainToYards(this double x) => Units.Length.Chain.toYards(x);
    ...
    public static double ChainToFurlongs(this double x) => Units.Length.Chain.toFurlongs(x);
    public static double ChainToLeagues(this double x) => Units.Length.Chain.toLeagues(x);
    public static double ChainToHands(this double x) => Units.Length.Chain.toHands(x);
    public static double ChainToRods(this double x) => Units.Length.Chain.toRods(x);
}

public static class FurlongExtensions
{
    public static double FurlongToInches(this double x) => Units.Length.Furlong.toInches(x);
    public static double FurlongToFeet(this double x) => Units.Length.Furlong.toFeet(x);
    public static double FurlongToYards(this double x) => Units.Length.Furlong.toYards(x);
    ...
    public static double FurlongToChains(this double x) => Units.Length.Furlong.toChains(x);
    public static double FurlongToLeagues(this double x) => Units.Length.Furlong.toLeagues(x);
    public static double FurlongToHands(this double x) => Units.Length.Furlong.toHands(x);
    public static double FurlongToRods(this double x) => Units.Length.Furlong.toRods(x);
}

public static class LeagueExtensions
{
    public static double LeagueToInches(this double x) => Units.Length.League.toInches(x);
    public static double LeagueToFeet(this double x) => Units.Length.League.toFeet(x);
    public static double LeagueToYards(this double x) => Units.Length.League.toYards(x);
    ...
    public static double LeagueToChains(this double x) => Units.Length.League.toChains(x);
    public static double LeagueToFurlongs(this double x) => Units.Length.League.toFurlongs(x);
    public static double LeagueToHands(this double x) => Units.Length.League.toHands(x);
    public static double LeagueToRods(this double x) => Units.Length.League.toRods(x);
}

public static class HandExtensions
{
    public static double HandToInches(this double x) => Units.Length.Hand.toInches(x);
    public static double HandToFeet(this double x) => Units.Length.Hand.toFeet(x);
    public static double HandToYards(this double x) => Units.Length.Hand.toYards(x);
    ...
    public static double HandToChains(this double x) => Units.Length.Hand.toChains(x);
    public static double HandToFurlongs(this double x) => Units.Length.Hand.toFurlongs(x);
    public static double HandToLeagues(this double x) => Units.Length.Hand.toLeagues(x);
    public static double HandToRods(this double x) => Units.Length.Hand.toRods(x);
}