...
let areaTests config =
    ...
    let squareFootConversionTests =
        [
            ...
            "To square centimeters and back",
            (fun x -> x |> SquareFoot.toSquareCentimeters |> SquareCentimeter.toSquareFeet)
    ...
    let squareCentimeterConversionTests =
        [
            "To square inches and back",
            (fun x -> x |> SquareCentimeter.toSquareInches |> SquareInch.toSquareCentimeters)
            "To square feet and back", (fun x -> x |> SquareCentimeter.toSquareFeet |> SquareFoot.toSquareCentimeters)
            "To square meters and back",
            (fun x -> x |> SquareCentimeter.toSquareMeters |> SquareMeter.toSquareCentimeters)
        ]
...
let volumeTests config =
    ...
    let cubicInchConversionTests =
        [
            ...
            "To cubic centimeters and back",
            (fun x -> x |> CubicInch.toCubicCentimeters |> CubicCentimeter.toCubicInches)
    ...
    let cubicMeterConversionTests =
        [
            ...
            "To cubic centimeters and back",
            (fun x -> x |> CubicMeter.toCubicCentimeters |> CubicCentimeter.toCubicMeters)
...
let powerTests config =
    ...
    let horsepowerConversionTests =
        [
            ...
            (fun x -> x |> Horsepower.toTonsOfRefrigeration |> TonOfRefrigeration.toHorsepower)
        ]
    ...
    let tonOfRefrigerationConversionTests =
        [
            ...
            (fun x -> x |> TonOfRefrigeration.toWatts |> Watt.toTonsOfRefrigeration)
...
let energyTests config =
    ...
    let jouleConversionTests =
        [
            ...
            (fun x -> x |> Joule.toBritishThermalUnits |> BritishThermalUnit.toJoules)
    ...
    let britishThermalUnitConversionTests =
        [
            ...
            (fun x -> x |> BritishThermalUnit.toQs |> Q.toBritishThermalUnits)
        ]
    ...
    let quadConversionTests =
        [
            ...
            "To british thermal units and back",
            (fun x -> x |> Quad.toBritishThermalUnits |> BritishThermalUnit.toQuads)
