...
let areaTests config =
    ...
    let squareInchConversionTests =
        [
            "From square inch to square feet and back",
            (fun x -> SquareInch.create x |> SquareInch.toSquareFeet |> SquareFoot.toSquareInches)
            "From square inch to square centimeters and back",
            (fun x ->
                SquareInch.create x
                |> SquareInch.toSquareCentimeters
                |> SquareCentimeter.toSquareInches)
            "From square inch to square meters and back",
            (fun x ->
                SquareInch.create x |> SquareInch.toSquareMeters |> SquareMeter.toSquareInches)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let squareFootConversionTests =
        [
            "From square foot to square inches and back",
            (fun x -> SquareFoot.create x |> SquareFoot.toSquareInches |> SquareInch.toSquareFeet)
            "From square foot to square centimeters and back",
            (fun x ->
                SquareFoot.create x
                |> SquareFoot.toSquareCentimeters
                |> SquareCentimeter.toSquareFeet)
            "From square foot to square meters and back",
            (fun x -> SquareFoot.create x |> SquareFoot.toSquareMeters |> SquareMeter.toSquareFeet)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let squareCentimeterConversionTests =
        [
            "From square centimeter to square inches and back",
            (fun x ->
                SquareCentimeter.create x
                |> SquareCentimeter.toSquareInches
                |> SquareInch.toSquareCentimeters)
            "From square centimeter to square feet and back",
            (fun x ->
                SquareCentimeter.create x
                |> SquareCentimeter.toSquareFeet
                |> SquareFoot.toSquareCentimeters)
            "From square centimeter to square meters and back",
            (fun x ->
                SquareCentimeter.create x
                |> SquareCentimeter.toSquareMeters
                |> SquareMeter.toSquareCentimeters)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let squareMeterConversionTests =
        [
            "From square meter to square inches and back",
            (fun x ->
                SquareMeter.create x |> SquareMeter.toSquareInches |> SquareInch.toSquareMeters)
            "From square meter to square feet and back",
            (fun x -> SquareMeter.create x |> SquareMeter.toSquareFeet |> SquareFoot.toSquareMeters)
            "From square meter to square centimeters and back",
            (fun x ->
                SquareMeter.create x
                |> SquareMeter.toSquareCentimeters
                |> SquareCentimeter.toSquareMeters)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let volumeTests config =
    ...
    let cubicInchConversionTests =
        [
            "From cubic inch to cubic feet and back",
            (fun x -> CubicInch.create x |> CubicInch.toCubicFeet |> CubicFoot.toCubicInches)
            "From cubic inch to cubic centimeters and back",
            (fun x ->
                CubicInch.create x
                |> CubicInch.toCubicCentimeters
    ...
    let cubicFootConversionTests =
        [
            "From cubic foot to cubic inches and back",
            (fun x -> CubicFoot.create x |> CubicFoot.toCubicInches |> CubicInch.toCubicFeet)
            "From cubic foot to cubic centimeters and back",
            (fun x ->
                CubicFoot.create x
                |> CubicFoot.toCubicCentimeters
    ...
    let cubicCentimeterConversionTests =
        [
            "From cubic centimeter to cubic inches and back",
            (fun x ->
                CubicCentimeter.create x
                |> CubicCentimeter.toCubicInches
                |> CubicInch.toCubicCentimeters)
            "From cubic centimeter to cubic feet and back",
            (fun x ->
                CubicCentimeter.create x
                |> CubicCentimeter.toCubicFeet
                |> CubicFoot.toCubicCentimeters)
            "From cubic centimeter to cubic meters and back",
            (fun x ->
                CubicCentimeter.create x
    ...
    let cubicMeterConversionTests =
        [
            "From cubic meter to cubic inches and back",
            (fun x -> CubicMeter.create x |> CubicMeter.toCubicInches |> CubicInch.toCubicMeters)
            "From cubic meter to cubic feet and back",
            (fun x -> CubicMeter.create x |> CubicMeter.toCubicFeet |> CubicFoot.toCubicMeters)
            "From cubic meter to cubic centimeters and back",
            (fun x ->
                CubicMeter.create x
                |> CubicMeter.toCubicCentimeters
                |> CubicCentimeter.toCubicMeters)
...
let inertiaTests config =
    ...
    let quarticInchConversionTests =
        [
            "From quartic inch to quartic centimeters and back",
            (fun x ->
                QuarticInch.create x
                |> QuarticInch.toQuarticCentimeters
                |> QuarticCentimeter.toQuarticInches)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let quarticCentimeterConversionTests =
        [
            "From quartic centimeter to quartic inches and back",
            (fun x ->
                QuarticCentimeter.create x
                |> QuarticCentimeter.toQuarticInches
                |> QuarticInch.toQuarticCentimeters)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let speedTests config =
    ...
    let feetPerSecondTests =
        [
            ...
            (fun x ->
                FootPerSecond.create x
                |> FootPerSecond.toMetersPerSecond
                |> MeterPerSecond.toFeetPerSecond)
            "From feet per second to kilometers per hour and back",
            (fun x ->
                FootPerSecond.create x
                |> FootPerSecond.toKilometersPerHour
                |> KilometerPerHour.toFeetPerSecond)
            "From feet per second to miles per hour and back",
            (fun x ->
                FootPerSecond.create x
                |> FootPerSecond.toMilesPerHour
                |> MilePerHour.toFeetPerSecond)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
    ...
    let metersPerSecondTests =
        [
            ...
            (fun x ->
                MeterPerSecond.create x
                |> MeterPerSecond.toFeetPerSecond
                |> FootPerSecond.toMetersPerSecond)
            "From meter per second to kilometers per hour and back",
            (fun x ->
                MeterPerSecond.create x
                |> MeterPerSecond.toKilometersPerHour
                |> KilometerPerHour.toMetersPerSecond)
            "From meter per second to miles per hour and back",
            (fun x ->
                MeterPerSecond.create x
                |> MeterPerSecond.toMilesPerHour
                |> MilePerHour.toMetersPerSecond)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
    ...
    let kilometersPerHourTests =
        [
            ...
            (fun x ->
                KilometerPerHour.create x
                |> KilometerPerHour.toMilesPerHour
                |> MilePerHour.toKilometersPerHour)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let forceTests config =
    ...
    let newtonConversionTests =
        [
            "From newton to pound force and back",
            (fun x -> Newton.create x |> Newton.toPoundForce |> PoundForce.toNewtons)
            "From newton to dynes and back",
            (fun x -> Newton.create x |> Newton.toDynes |> Dyne.toNewtons)
            "From newton to kips and back",
            (fun x -> Newton.create x |> Newton.toKips |> Kip.toNewtons)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let poundForceConversionTests =
        [
            "From pound force to newtons and back",
            (fun x -> PoundForce.create x |> PoundForce.toNewtons |> Newton.toPoundForce)
            "From pound force to dynes and back",
            (fun x -> PoundForce.create x |> PoundForce.toDynes |> Dyne.toPoundForce)
            "From pound force to kips and back",
            (fun x -> PoundForce.create x |> PoundForce.toKips |> Kip.toPoundForce)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let dyneConversionTests =
        [
            "From dyne to newtons and back",
            (fun x -> Dyne.create x |> Dyne.toNewtons |> Newton.toDynes)
            "From dyne to pound force and back",
            (fun x -> Dyne.create x |> Dyne.toPoundForce |> PoundForce.toDynes)
    ...
    let kipConversionTests =
        [
            "From kip to newtons and back",
            (fun x -> Kip.create x |> Kip.toNewtons |> Newton.toKips)
            "From kip to pound force and back",
            (fun x -> Kip.create x |> Kip.toPoundForce |> PoundForce.toKips)
...
let dataTransferRateTests config =
    ...
    let baudPerSecondConversionTests =
        [
            ...
            (fun x -> Baud.create x |> Baud.toBitsPerSecond |> BitPerSecond.toBauds)
            "From baud to kilobits per second",
            (fun x -> Baud.create x |> Baud.toKilobitsPerSecond |> KilobitPerSecond.toBauds)
            "From baud to megabits per second",
            (fun x -> Baud.create x |> Baud.toMegabitsPerSecond |> MegabitPerSecond.toBauds)
            "From baud to gigabits per second",
            (fun x -> Baud.create x |> Baud.toGigabitsPerSecond |> GigabitPerSecond.toBauds)
            "From baud to terabits per second",
            (fun x -> Baud.create x |> Baud.toTerabitsPerSecond |> TerabitPerSecond.toBauds)
            "From baud to petabits per second",
            (fun x -> Baud.create x |> Baud.toPetabitsPerSecond |> PetabitPerSecond.toBauds)
            "From baud to bytes per second",
            (fun x -> Baud.create x |> Baud.toBytesPerSecond |> BytePerSecond.toBauds)
            "From baud to kilobytes per second",
            (fun x -> Baud.create x |> Baud.toKilobytesPerSecond |> KilobytePerSecond.toBauds)
            "From baud to megabytes per second",
            (fun x -> Baud.create x |> Baud.toMegabytesPerSecond |> MegabytePerSecond.toBauds)
            "From baud to gigabytes per second",
            (fun x -> Baud.create x |> Baud.toGigabytesPerSecond |> GigabytePerSecond.toBauds)
            "From baud to terabytes per second",
            (fun x -> Baud.create x |> Baud.toTerabytesPerSecond |> TerabytePerSecond.toBauds)
            "From baud to petabytes per second",
            (fun x -> Baud.create x |> Baud.toPetabytesPerSecond |> PetabytePerSecond.toBauds)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let bitPerSecondConversionTests =
        [
            "From bit per second to baud",
            (fun x -> BitPerSecond.create x |> BitPerSecond.toBauds |> Baud.toBitsPerSecond)
            "From bit per second to kilobits per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toKilobitsPerSecond
                |> KilobitPerSecond.toBitsPerSecond)
            "From bit per second to megabits per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toMegabitsPerSecond
                |> MegabitPerSecond.toBitsPerSecond)
            "From bit per second to gigabits per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toGigabitsPerSecond
                |> GigabitPerSecond.toBitsPerSecond)
            "From bit per second to terabits per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toTerabitsPerSecond
                |> TerabitPerSecond.toBitsPerSecond)
            "From bit per second to petabits per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toPetabitsPerSecond
                |> PetabitPerSecond.toBitsPerSecond)
            "From bit per second to bytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toBytesPerSecond
                |> BytePerSecond.toBitsPerSecond)
            "From bit per second to kilobytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toKilobytesPerSecond
                |> KilobytePerSecond.toBitsPerSecond)
            "From bit per second to megabytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toMegabytesPerSecond
                |> MegabytePerSecond.toBitsPerSecond)
            "From bit per second to gigabytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toGigabytesPerSecond
                |> GigabytePerSecond.toBitsPerSecond)
            "From bit per second to terabytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toTerabytesPerSecond
                |> TerabytePerSecond.toBitsPerSecond)
            "From bit per second to petabytes per second",
            (fun x ->
                BitPerSecond.create x
                |> BitPerSecond.toPetabytesPerSecond
                |> PetabytePerSecond.toBitsPerSecond)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let kilobitPerSecondConversionTests =
        [
            "From kilobit per second to baud",
            (fun x ->
                KilobitPerSecond.create x
                |> KilobitPerSecond.toBauds
                |> Baud.toKilobitsPerSecond)
            ...
            (fun x ->
                KilobitPerSecond.create x
                |> KilobitPerSecond.toBytesPerSecond
                |> BytePerSecond.toKilobitsPerSecond)
    ...
    let megabitPerSecondConversionTests =
        [
            "From megabit per second to baud",
            (fun x ->
                MegabitPerSecond.create x
                |> MegabitPerSecond.toBauds
                |> Baud.toMegabitsPerSecond)
            ...
            (fun x ->
                MegabitPerSecond.create x
                |> MegabitPerSecond.toBytesPerSecond
                |> BytePerSecond.toMegabitsPerSecond)
    ...
    let gigabitPerSecondConversionTests =
        [
            "From gigabit per second to baud",
            (fun x ->
                GigabitPerSecond.create x
                |> GigabitPerSecond.toBauds
                |> Baud.toGigabitsPerSecond)
            ...
            (fun x ->
                GigabitPerSecond.create x
                |> GigabitPerSecond.toBytesPerSecond
                |> BytePerSecond.toGigabitsPerSecond)
    ...
    let terabitPerSecondConversionTests =
        [
            "From terabit per second to baud",
            (fun x ->
                TerabitPerSecond.create x
                |> TerabitPerSecond.toBauds
                |> Baud.toTerabitsPerSecond)
            ...
            (fun x ->
                TerabitPerSecond.create x
                |> TerabitPerSecond.toBytesPerSecond
                |> BytePerSecond.toTerabitsPerSecond)
    ...
    let petabitPerSecondConversionTests =
        [
            "From petabit per second to baud",
            (fun x ->
                PetabitPerSecond.create x
                |> PetabitPerSecond.toBauds
                |> Baud.toPetabitsPerSecond)
            ...
            (fun x ->
                PetabitPerSecond.create x
                |> PetabitPerSecond.toBytesPerSecond
                |> BytePerSecond.toPetabitsPerSecond)
    ...
    let bytePerSecondConversionTests =
        [
            "From byte per second to baud",
            (fun x -> BytePerSecond.create x |> BytePerSecond.toBauds |> Baud.toBytesPerSecond)
            "From byte per second to bits per second",
            (fun x ->
                BytePerSecond.create x
                |> BytePerSecond.toBitsPerSecond
                |> BitPerSecond.toBytesPerSecond)
            ...
            (fun x ->
                BytePerSecond.create x
                |> BytePerSecond.toKilobytesPerSecond
                |> KilobytePerSecond.toBytesPerSecond)
            "From byte per second to megabytes per second",
            (fun x ->
                BytePerSecond.create x
                |> BytePerSecond.toMegabytesPerSecond
                |> MegabytePerSecond.toBytesPerSecond)
            "From byte per second to gigabytes per second",
            (fun x ->
                BytePerSecond.create x
                |> BytePerSecond.toGigabytesPerSecond
                |> GigabytePerSecond.toBytesPerSecond)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let kilobytePerSecondConversionTests =
        [
            "From kilobyte per second to baud",
            (fun x ->
                KilobytePerSecond.create x
                |> KilobytePerSecond.toBauds
                |> Baud.toKilobytesPerSecond)
    ...
    let megabytePerSecondConversionTests =
        [
            "From megabyte per second to baud",
            (fun x ->
                MegabytePerSecond.create x
                |> MegabytePerSecond.toBauds
                |> Baud.toMegabytesPerSecond)
    ...
    let gigabytePerSecondConversionTests =
        [
            "From gigabyte per second to baud",
            (fun x ->
                GigabytePerSecond.create x
                |> GigabytePerSecond.toBauds
                |> Baud.toGigabytesPerSecond)
    ...
    let terabytePerSecondConversionTests =
        [
            "From terabyte per second to baud",
            (fun x ->
                TerabytePerSecond.create x
                |> TerabytePerSecond.toBauds
                |> Baud.toTerabytesPerSecond)
            ...
            (fun x ->
                TerabytePerSecond.create x
                |> TerabytePerSecond.toBytesPerSecond
                |> BytePerSecond.toTerabytesPerSecond)
    ...
    let petabytePerSecondConversionTests =
        [
            "From petabyte per second to baud",
            (fun x ->
                PetabytePerSecond.create x
                |> PetabytePerSecond.toBauds
                |> Baud.toPetabytesPerSecond)
            ...
            (fun x ->
                PetabytePerSecond.create x
                |> PetabytePerSecond.toBytesPerSecond
                |> BytePerSecond.toPetabytesPerSecond)
...
let densityTests config =
    ...
    let kilogramPerCubicMeterConversionTests =
        [
            ...
            (fun x ->
                KilogramPerCubicMeter.create x
    ...
    let gramPerCubicCentimeterConversionTests =
        [
            ...
            (fun x ->
                GramPerCubicCentimeter.create x
                |> GramPerCubicCentimeter.toKilogramsPerCubicMeter
                |> KilogramPerCubicMeter.toGramsPerCubicCentimeter)
    ...
    let poundMassPerCubicFootConversionTests =
        [
            ...
            (fun x ->
                PoundMassPerCubicFoot.create x
                |> PoundMassPerCubicFoot.toKilogramsPerCubicMeter
                |> KilogramPerCubicMeter.toPoundMassPerCubicFoot)
    ...
    let poundMassPerCubicInchConversionTests =
        [
            ...
            (fun x ->
                PoundMassPerCubicInch.create x
                |> PoundMassPerCubicInch.toKilogramsPerCubicMeter
                |> KilogramPerCubicMeter.toPoundMassPerCubicInch)
    ...
    testList
        ...
        [
            testList
                "Kilogram per cubic meter conversion tests -> "
                kilogramPerCubicMeterConversionTests
            testList
                "Gram per cubic centimeter conversion tests -> "
                gramPerCubicCentimeterConversionTests
            testList
                "Pound mass per cubic foot conversion tests -> "
                poundMassPerCubicFootConversionTests
            testList
                "Pound mass per cubic inch conversion tests -> "
                poundMassPerCubicInchConversionTests
        ]
...
let pressureTests config =
    ...
    let pascalConversionTests =
        [
            "From pascal to pounds per square inch",
            (fun x ->
                Pascal.create x |> Pascal.toPoundsPerSquareInch |> PoundPerSquareInch.toPascals)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
    ...
    let poundPerSquareInchConversionTests =
        [
            ...
            (fun x ->
                PoundPerSquareInch.create x
                |> PoundPerSquareInch.toPascals
                |> Pascal.toPoundsPerSquareInch)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let powerTests config =
    ...
    let wattConversionTests =
        [
            ...
            (fun x -> Watt.create x |> Watt.toKilowatts |> Kilowatt.toWatts)
            "From watt to horsepower",
            (fun x -> Watt.create x |> Watt.toHorsepower |> Horsepower.toWatts)
            "From watt to tons of refrigeration",
            (fun x -> Watt.create x |> Watt.toTonsOfRefrigeration |> TonOfRefrigeration.toWatts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let kilowattConversionTests =
        [
            "From kilowatt to watt",
            (fun x -> Kilowatt.create x |> Kilowatt.toWatts |> Watt.toKilowatts)
            "From kilowatt to horsepower",
            (fun x -> Kilowatt.create x |> Kilowatt.toHorsepower |> Horsepower.toKilowatts)
            "From kilowatt to tons of refrigeration",
            (fun x ->
                Kilowatt.create x
                |> Kilowatt.toTonsOfRefrigeration
                |> TonOfRefrigeration.toKilowatts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let horsepowerConversionTests =
        [
            "From horsepower to watt",
            (fun x -> Horsepower.create x |> Horsepower.toWatts |> Watt.toHorsepower)
            "From horsepower to kiloWatt",
            (fun x -> Horsepower.create x |> Horsepower.toKilowatts |> Kilowatt.toHorsepower)
            "From horsepower to tons of refrigeration",
            (fun x ->
                Horsepower.create x
                |> Horsepower.toTonsOfRefrigeration
                |> TonOfRefrigeration.toHorsepower)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let tonOfRefrigerationConversionTests =
        [
            "From tons of refrigeration to watt",
            (fun x ->
                TonOfRefrigeration.create x
                |> TonOfRefrigeration.toWatts
                |> Watt.toTonsOfRefrigeration)
...
let energyTests config =
    ...
    let jouleConversionTests =
        [
            "From joule to kilojoule and back",
            (fun x -> Joule.create x |> Joule.toKilojoules |> Kilojoule.toJoules)
            "From joule to british thermal units and back",
            (fun x -> Joule.create x |> Joule.toBritishThermalUnits |> BritishThermalUnit.toJoules)
            "From joule to calories and back",
            (fun x -> Joule.create x |> Joule.toCalories |> Calorie.toJoules)
            "From joule to quads and back",
            (fun x -> Joule.create x |> Joule.toQuads |> Quad.toJoules)
    ...
    let kilojouleConversionTests =
        [
            "From kilojoule to joule and back",
            (fun x -> Kilojoule.create x |> Kilojoule.toJoules |> Joule.toKilojoules)
            "From kilojoule to british thermal units and back",
            (fun x ->
                Kilojoule.create x
                |> Kilojoule.toBritishThermalUnits
                |> BritishThermalUnit.toKilojoules)
            "From kilojoule to calories and back",
            (fun x -> Kilojoule.create x |> Kilojoule.toCalories |> Calorie.toKilojoules)
            "From kilojoule to quads and back",
            (fun x -> Kilojoule.create x |> Kilojoule.toQuads |> Quad.toKilojoules)
            "From kilojoule to Qs and back",
            (fun x -> Kilojoule.create x |> Kilojoule.toQs |> Q.toKilojoules)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
    ...
    let britishThermalUnitConversionTests =
        [
            ...
            (fun x ->
                ...
                |> BritishThermalUnit.toJoules
                |> Joule.toBritishThermalUnits)
            ...
            (fun x ->
                BritishThermalUnit.create x
                |> BritishThermalUnit.toCalories
                |> Calorie.toBritishThermalUnits)
            "From british thermal unit to quads and back",
            (fun x ->
                BritishThermalUnit.create x
                |> BritishThermalUnit.toQuads
                |> Quad.toBritishThermalUnits)
            "From british thermal unit to Qs and back",
            (fun x ->
                BritishThermalUnit.create x
                |> BritishThermalUnit.toQs
                |> Q.toBritishThermalUnits)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let calorieConversionTests =
        [
            "From calorie to joule and back",
            (fun x -> Calorie.create x |> Calorie.toJoules |> Joule.toCalories)
            "From calorie to kilojoule and back",
            (fun x -> Calorie.create x |> Calorie.toKilojoules |> Kilojoule.toCalories)
            "From calorie to british thermal units and back",
            (fun x ->
                Calorie.create x
                |> Calorie.toBritishThermalUnits
                |> BritishThermalUnit.toCalories)
            "From calorie to quads and back",
            (fun x -> Calorie.create x |> Calorie.toQuads |> Quad.toCalories)
            "From calorie to Qs and back",
            (fun x -> Calorie.create x |> Calorie.toQs |> Q.toCalories)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let quadConversionTests =
        [
            "From quad to joule and back",
            (fun x -> Quad.create x |> Quad.toJoules |> Joule.toQuads)
            "From quad to kilojoule and back",
            (fun x -> Quad.create x |> Quad.toKilojoules |> Kilojoule.toQuads)
            "From quad to british thermal units and back",
            (fun x -> Quad.create x |> Quad.toBritishThermalUnits |> BritishThermalUnit.toQuads)
            "From quad to calories and back",
            (fun x -> Quad.create x |> Quad.toCalories |> Calorie.toQuads)
    ...
    let qConversionTests =
        [
            ...
            "From Q to kilojoule and back",
            (fun x -> Q.create x |> Q.toKilojoules |> Kilojoule.toQs)
            "From Q to british thermal units and back",
            (fun x -> Q.create x |> Q.toBritishThermalUnits |> BritishThermalUnit.toQs)
    ...
    let ampereSecondConversionTests =
        [
            ...
            (fun x ->
                ...
                |> AmpereSecond.toAmpereHours
                |> AmpereHour.toAmpereSeconds)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let electromotiveForceTests config =
    ...
    let microvoltConversionTests =
        [
            "From microvolt to millivolts and back",
            (fun x -> Microvolt.create x |> Microvolt.toMillivolts |> Millivolt.toMicrovolts)
            "From microvolt to volts and back",
            (fun x -> Microvolt.create x |> Microvolt.toVolts |> Volt.toMicrovolts)
            "From microvolt to kilovolts and back",
            (fun x -> Microvolt.create x |> Microvolt.toKilovolts |> Kilovolt.toMicrovolts)
            "From microvolt to megavolts and back",
            (fun x -> Microvolt.create x |> Microvolt.toMegavolts |> Megavolt.toMicrovolts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let millivoltConversionTests =
        [
            "From millivolt to microvolts and back",
            (fun x -> Millivolt.create x |> Millivolt.toMicrovolts |> Microvolt.toMillivolts)
            "From millivolt to volts and back",
            (fun x -> Millivolt.create x |> Millivolt.toVolts |> Volt.toMillivolts)
            "From millivolt to kilovolts and back",
            (fun x -> Millivolt.create x |> Millivolt.toKilovolts |> Kilovolt.toMillivolts)
            "From millivolt to megavolts and back",
            (fun x -> Millivolt.create x |> Millivolt.toMegavolts |> Megavolt.toMillivolts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let voltConversionTests =
        [
            "From volt to microvolts and back",
            (fun x -> Volt.create x |> Volt.toMicrovolts |> Microvolt.toVolts)
            "From volt to millivolts and back",
            (fun x -> Volt.create x |> Volt.toMillivolts |> Millivolt.toVolts)
            "From volt to kilovolts and back",
            (fun x -> Volt.create x |> Volt.toKilovolts |> Kilovolt.toVolts)
            "From volt to megavolts and back",
            (fun x -> Volt.create x |> Volt.toMegavolts |> Megavolt.toVolts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let kilovoltConversionTests =
        [
            "From kilovolt to microvolts and back",
            (fun x -> Kilovolt.create x |> Kilovolt.toMicrovolts |> Microvolt.toKilovolts)
            "From kilovolt to millivolts and back",
            (fun x -> Kilovolt.create x |> Kilovolt.toMillivolts |> Millivolt.toKilovolts)
            "From kilovolt to volts and back",
            (fun x -> Kilovolt.create x |> Kilovolt.toVolts |> Volt.toKilovolts)
            "From kilovolt to megavolts and back",
            (fun x -> Kilovolt.create x |> Kilovolt.toMegavolts |> Megavolt.toKilovolts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let megavoltConversionTests =
        [
            "From megavolt to microvolts and back",
            (fun x -> Megavolt.create x |> Megavolt.toMicrovolts |> Microvolt.toMegavolts)
            "From megavolt to millivolts and back",
            (fun x -> Megavolt.create x |> Megavolt.toMillivolts |> Millivolt.toMegavolts)
            "From megavolt to volts and back",
            (fun x -> Megavolt.create x |> Megavolt.toVolts |> Volt.toMegavolts)
            "From megavolt to kilovolts and back",
            (fun x -> Megavolt.create x |> Megavolt.toKilovolts |> Kilovolt.toMegavolts)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
...
let inductanceTests config =
    ...
    let microHenryConversionTest =
        [
            "From micro Henry to milli Henry and back",
            (fun x -> MicroHenry.create x |> MicroHenry.toMilliHenrys |> MilliHenry.toMicroHenrys)
            "From micro Henry to Henry and back",
            (fun x -> MicroHenry.create x |> MicroHenry.toHenrys |> Henry.toMicroHenrys)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let milliHenryConversionTest =
        [
            "From milli Henry to micro Henry and back",
            (fun x -> MilliHenry.create x |> MilliHenry.toMicroHenrys |> MicroHenry.toMilliHenrys)
            "From milli Henry to Henry and back",
            (fun x -> MilliHenry.create x |> MilliHenry.toHenrys |> Henry.toMilliHenrys)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)

    let henryConversionTest =
        [
            "From Henry to micro Henry and back",
            (fun x -> Henry.create x |> Henry.toMicroHenrys |> MicroHenry.toHenrys)
            "From Henry to milli Henry and back",
            (fun x -> Henry.create x |> Henry.toMilliHenrys |> MilliHenry.toHenrys)
        ]
        |> List.map (fun (x, y) -> testConversionRoundingError config Accuracy.high x y)
